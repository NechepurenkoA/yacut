...
def create_short_url():
    ...
    if 'custom_id' in data:
        ...
        elif not re.fullmatch(REGULAR_EXPRESSION_FOR_CUSTOM_ID, custom_id) or len(data['custom_id']) > 16:
    ...
    if URLMap.query.filter_by(short=custom_id).first():
        ...
        return jsonify({'url': url.original, 'short_link': urljoin(base_url, url.short)}), 201
...
def get_short_url(short: str):
    ...
    return jsonify({'url': url_model.original}), 200
